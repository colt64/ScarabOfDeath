...
---
# Description
Hound wraith are identical to the common wraith found in the Monster Manual, except that they look like dog-shaped shadows, they have an Intelligence score of 7, and they have advantage on Wisdom (Perception) checks that rely on hearing or smell. Their behavior is also more animal than human.

# Hound Wraith Statblock

```statblock
name: Hound Wraith
source: Scarab of Death © Benoi de Bernardy 2017
size: Medium
type: undead
subtype: ""
...
traits:
  - name: Heightened Senses
    desc: The hound wraith has advantage on Wisdom (Perception) checks that rely on hearing or smell
